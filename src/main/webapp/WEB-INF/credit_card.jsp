...
<%@page import="java.util.ArrayList"%>
    ...
    <%
        ...
        try {
            ...
            obj.setItemName("FarmerPaPa信用卡-" + order.getId() + " $" + order.getTotalAmountWithFee() + "元"); //請將字串中非常好書改成你的web site 中文/英文名稱
            ...
            String orderIdStr = "fpapa" //請改成你的webapp名稱,產生一個allpay要求的訂單編號字串(必須<=20個英數字字元,且不得與之前的訂單重複)
